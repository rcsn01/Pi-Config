...
// Generated: 2026-08-27T03:29:55.118Z
// Model count: 20
...
export const MODEL_PRICING: Record<string, ModelPrice> = {
  ...
  "deepseek-v4-pro:preview": { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 },
  "gemma4:31b": { input: 0.09, output: 0.34, cacheRead: 0.05, cacheWrite: 0 },
  "glm-5.1": { input: 1.4, output: 4.4, cacheRead: 0.26, cacheWrite: 0 },
  "glm-5.2": { input: 1.4, output: 4.4, cacheRead: 0.26, cacheWrite: 0 },
  "glm-5.3-flash": { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 },
  ...
  "nemotron-3-nano:30b": { input: 0.05, output: 0.2, cacheRead: 0.025, cacheWrite: 0 },
